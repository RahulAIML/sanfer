...
const t = {
  es: {
    ...
    cert_certified_def: 'Certificado = completó los 3 simuladores asignados a su línea durante el período.',
  ...
  en: {
    ...
    cert_certified_def: 'Certified = completed all 3 simulators assigned to their line during the period.',
